                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                <div class="card-body">
                                <h5 class="card-title">Dastur: <span>| {{ $item->comment }}</span></h5>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form action="{{route('admin.cources.store')}}" method="POST">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel2">Kurs Yaratish</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-sm-12">
                        <input type="text" class="form-control" placeholder="Kursning To'liq nomi" name="name"   required>
                    </div>
                    <p></p>

                    <div class="col-sm-12">
                        <input type="number" class="form-control" placeholder="Necha Oy Davom Etishi" name="month"   required>
                    </div>
                    <p></p>

                    <div class="col-sm-12">
                        <input type="text" class="form-control" placeholder="Kursda nimalar o'rgatiladi" name="comment"   required>
                    </div>
                    <p></p>
                </div>
            </div>
